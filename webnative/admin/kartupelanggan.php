    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalKartuPelangganLabel">Tambah Kartu Membership</h5>
            ...
            <form action="controllers/kartumember_controllers.php" method="POST">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="proses" value="setKartu">Submit</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <table id="datatablesSimple">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="controllers/kartumember_controllers.php" method="POST"> 
                            <a href="index.php?url=kartu_details&id=<?=$row['id']?>" class="btn btn-info btn-sm">Details</a>
